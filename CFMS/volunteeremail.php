...
if ($row = mysqli_fetch_array(mysqli_query($conn, "SELECT * from tbl_volunteer ORDER BY id desc LIMIT 1"))) {
...
<body>
    ...
    <div class='content'>
        ...
        <p>Thank you For Registering As Volunteer. Here are your details:</p>
        <p><strong>User Name:</strong> $names</p>
        <p><strong>Volunteer ID:</strong> $id</p>
