<?php 
    ...
    if (isset($_POST['btnsubmit'])) {
        ...
        $sql="INSERT INTO tbl_volunteer(vol_id,vol_name,user_id,event_id,reg_date) VALUES  ('$vol_id','$name','$user_id','$event_id','$reg_date')";
            ...
            <div class="content-page">
              ...
              <div class="row flex-between-center">
                ...
                <div class="col-auto">
                  ...
                  <input type="submit" class="btn btn-primary" name="btnsubmit" role="button" value="Add Volunteer">
                </div>
              </div>
            </div>
          </div>
