...
$sql = "SELECT * FROM tbl_volunteer WHERE status=1 ";
...
<head>
    <meta charset="utf-8" />
    <title>ADMIN | CFMS | View Volunteers</title>
                                        ...
                                        <table class="table table-hover table-centered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    ?>
                                                        <td><?php echo $data['vol_id']; ?></td>
                                                        <td><?php echo $data['vol_name']; ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="delete_volunteer.php?id=<?php echo $data['vol_id']; ?>" style="text-decoration:none;"><i class="fa fa-trash" aria-hidden="true" style="font-size:20px;"></i></a>
