...
if (isset($_GET['id'])) {
  $id = $_GET['id'];
  $select = "SELECT * from tbl_volunteer WHERE vol_id= '$id' ";
...
if (isset($_POST['btnsubmit'])) {
  ...
  $sql = "UPDATE tbl_volunteer SET vol_name='$name',user_id='$user_id',event_id='$event_id', reg_date ='$reg_date' WHERE vol_id = '$id' ";
...
<head>
  <meta charset="utf-8" />
  <title>ADMIN | CFMS | Update Volunteer</title>
          ...
          <form method="post">
            <div class="row flex-between-center">
              ...
              <div class="col-auto">
                ...
                <input type="submit" class="btn btn-primary" name="btnsubmit" role="button" value="Update Volunteer">
              </div>
            </div>
        </div>
      </div>
            ...
            <div class="card-body pt-0">
              ...
              <div class="row gx-2">
                <div class="col-md-6 col-sm-12 mb-2">
                  ...
                  <input type="text" class="form-control" name="name" value=" <?php echo $data['vol_name']; ?> " required />
                </div>
