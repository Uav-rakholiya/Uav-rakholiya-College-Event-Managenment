<?php 
    ...
    if (isset($_POST['btnsubmit'])) {
        ...
        $sql="INSERT INTO tbl_events(event_id,event_name,club_id,event_admin,date,time,capacity,description) VALUES  ('$event_id','$name','$club_id','$event_admin','$date','$time','$capacity','$description')";
        ...
        <div class="wrapper">
            ...
            <div class="content-page">
              ...
              <div class="row flex-between-center">
                ...
                <div class="col-auto">
                  <a href="view_event.php" class="btn btn-link text-secondary p-0 me-3 fw-medium">Discard</a>
                  <input type="submit" class="btn btn-primary" name="btnsubmit"  value="Create Event">
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body pt-0">
                  ...
                  <div class="row gx-2">
                      <div class="col-md-4 col-sm-12 mb-2">
                        ...
                        <input class="form-control" id="name" name="name" type="text"  required/></div>
                      ...
                      <div class="col-md-4 col-sm-12 ">
                        ...
                        <?php
                        $select="SELECT * from tbl_clubs WHERE status=1 ";
                  ...
                  <div class="col-md-4 col-sm-12 mb-2">
                        ...
                        <input class="form-control" id="description" name="capacity" type="text"  required/>
                      </div>
                      <div class="col-md-4 col-sm-12 mb-2">
                    ...
                    <div class="col-md-4 col-sm-12 mb-2">
                        ...
                        <select class="form-control" name="event_admin">
                        <option value="<?php echo $_SESSION['name']; ?>" disabled selected><?php echo $_SESSION['name']; ?></option>
