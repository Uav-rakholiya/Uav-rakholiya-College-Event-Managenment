        ...
        <div class="content-page">
            <div class="content">
                <div class="container-fluid pt-3">
                    <div class="row">
                        <div class="col-12">
                            <h1 class="text-center">Clubs Lists </h1>
                            <hr>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-4 col-md-6 col-sm-12 mt-3">
                                ...
                                <center>
                                    <div class="card" style="width: 100%;">
                                        <div class="card-body">
                                            <h3 class="card-title">Club Name : <?php echo $data['club_name']; ?></h3>
                                            <p class="card-text">Category : <?php echo $data['category']; ?></p>
                                            <p class="card-text">Capacity : <?php echo $data['capacity']; ?></p>
                                            <a href="view_events.php?id=<?php echo base64_encode($data['club_id']); ?>&name=<?php echo base64_encode($data['club_name']); ?>" class="btn btn-primary">View Details</a>
                                        </div>
                                    </div>
                                </center>
